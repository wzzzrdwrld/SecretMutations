...
import "https://github.com/wzzzrdwrld/SecretMutations/blob/main/MutantAlphaNFT.sol";
import "https://github.com/wzzzrdwrld/SecretMutations/blob/main/AlphaLogicToken.sol";

contract MAStakingContract is Ownable, IERC721Receiver {
  ...
  event NFTStaked
  (address owner, uint256 tokenId, uint256 value);
  ...
  MutantAlphas nft;
  AlphaLogicToken token;

  // maps tokenId to stake
  mapping(uint256 => Stake) public vault; 

   constructor(MutantAlphas _nft, AlphaLogicToken _token) { 
    nft = _nft;
    token = _token;
  }
